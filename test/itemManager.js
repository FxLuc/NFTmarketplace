...
contract("ItemManager", accounts => {
    it("...should be able to add an Item", async () => {
        ...
        const itemRawData = 'https\:\/\/semiconductor\.samsung\.com\/dram\/ddr\/ddr3\/'
        const itemRawDataHash = '0x3031303230333034000000000000000000000000000000000000000000000000'
        const result = await ItemManagerInstance.createItem(itemName, itemSpecifications, itemRawData, itemRawDataHash, {from: accounts[0]})
        console.log(result);
